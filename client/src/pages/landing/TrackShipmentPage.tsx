...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes! On the Box and Beyond dashboard, you can track all your shipments in one view with real-time status, filters, and bulk actions. Sign up for free to access.",
  },
];
  ...
  return (
    <>
                            ...
                            >
                              <span
                                className={`w-2 h-2 rounded-full ${
                                  delivered ? "bg-emerald-500" : "bg-violet-500"
                                }`}
                              />
                              <span
                                className={`text-xs font-semibold ${
                                  delivered ? "text-emerald-700" : "text-violet-700"
                                }`}
                              >
                                {label}
                              </span>
      ...
      <CtaBanner
        ...
        subtitle="Sign up for the Box and Beyond dashboard and get a unified tracking view for every order, every courier."
