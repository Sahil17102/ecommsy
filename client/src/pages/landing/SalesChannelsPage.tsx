...
const benefits = [
  {
    ...
    description:
      "New orders flow into your Box and Beyond dashboard the moment they're placed — zero manual work.",
  },
  {
...
const steps = [
  ...
  },
  {
    ...
    description:
      "Securely authorize Box and Beyond to sync your orders and inventory.",
  },
  {
      ...
      <section className="py-16 sm:py-24 bg-white">
        <Container maxWidth="lg">
          ...
          >
            <Link
              to="/signup"
              className="inline-flex items-center gap-2 px-7 py-3.5 text-sm font-semibold text-white bg-accent hover:bg-accent-hover rounded-lg transition-all no-underline shadow-lg shadow-purple-500/20 hover:shadow-purple-500/35"
            >
              Connect Your Store
