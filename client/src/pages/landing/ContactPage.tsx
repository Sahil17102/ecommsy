...
const channels = [
  {
    ...
    contact: "sales@searchcraftdigital.com",
    href: "mailto:sales@searchcraftdigital.com",
  },
  {
    ...
    contact: "cs@searchcraftdigital.com",
  ...
  },
  {
    ...
    contact: "partners@searchcraftdigital.com",
    href: "mailto:partners@searchcraftdigital.com",
  },
  {
    icon: <Phone className="w-5 h-5" />,
